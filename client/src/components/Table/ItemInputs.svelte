...
<form class='md:grid grid-cols-4 mb-5 gap-5' on:submit|preventDefault={appendItem}>
    <div class="flex flex-col">
	    ...
	    <input class='rounded-xl outline-0 focus:border-purple-800 focus:border-3 px-1 h-10' type="text" name="itemName" bind:value={item.itemName} required />
    </div>

    <div class="flex flex-col">
        <label for="itemQuantity">Quantity</label>
        <input class='rounded-xl outline-0 focus:border-purple-800 focus:border-3 px-1 h-10'type="number" name="itemQuantity" bind:value={item.itemQuantity} required/>
    </div>

    <div class="flex flex-col">
        <label for="itemPrice">Price</label>
        <input class='rounded-xl outline-0 focus:border-purple-800 focus:border-3 px-1 h-10 '
